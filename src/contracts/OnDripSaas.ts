...
export interface OnDripSaasInterface extends utils.Interface {
  functions: {
...
export interface OnDripSaas extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OnDripSaasInterface;
  ...
  functions: {
    ...
    ): Promise<[boolean] & { access: boolean }>;
